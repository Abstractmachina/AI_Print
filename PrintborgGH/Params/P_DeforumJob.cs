...
{
    public class P_DeforumJob : GH_Param<GH_DeforumJob>
    {
        public P_DeforumJob()
          : base("Deforum Job", "DJob",
              "Deforum Job object containing the information of a job on the server.",
        ...
        /// </summary>
        protected override GH_DeforumJob InstantiateT() {
            //return new GH_ObjectWrapper();
            return new GH_DeforumJob();
        }
