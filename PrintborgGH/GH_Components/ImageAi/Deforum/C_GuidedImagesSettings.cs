...
namespace PrintborgGH.GH_Components.ImageAi.Deforum
{
    public class C_GuidedImagesSettings : GH_Component
    {
        ...
        {
            pManager.AddTextParameter("Init Images", "Ini", "Init images as GH_Dictionary<string, string>", GH_ParamAccess.item, "");
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // try to cast initImages object. if empty or not provided, generate default values.
            var initImages = string.Empty;
            if (!DA.GetData(0, ref initImages)) return;
            if (initImages == "") initImages = GuidedImagesSettings.GenerateDefaultInitImages();
            ...
            //    initImages = GuidedImagesSettings.GenerateDefaultInitImages();
            //}
            //else {
            //    initImages = GuidedImagesSettings.GenerateDefaultInitImages();
            //}
